...
//display & color related constants
...
#define GREEN_COLOR al_map_rgb(0,255,0)
...
#define IDLE_TIME_THRESHOLD  20 //represents the amount of time before displaying idle animation
//measured in seconds
//#define IDLE_TIME_THRESHOLD 0

#define IDLE_TIME_MOVEMENT_THRESHOLD 1 //represents the amount of time between movement animation resets

#define REPEATED_MOVEMENT_THRESHOLD 5 //represents the number of keypresss that can be made for movement before ignore
...
////The max number of triangles the terrain for a level can
////be composed of 100 triangles = 50 quads
#define MAX_TERRAIN_TRIANGLES 100
